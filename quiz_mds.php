            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="quiz_mds_data.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div style="border-bottom: 2px solid #ddd; margin-bottom: 20px; padding-bottom: 10px; margin-top:2%;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="quizTitle" name="quiz_title" class="form-control" value="Management Advisory Services" readonly>
                                    </div>
                                </div>
