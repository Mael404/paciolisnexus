...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO gamified (student_id, full_name, birthdate, address, quiz_title, gcash_name, gcash_number, payment_proof, mds) 
              VALUES ('$student_id', '$full_name', '$birthdate', '$address', '$quiz_title', '$gcash_name', '$gcash_number', '$file_path', '$mds')";
