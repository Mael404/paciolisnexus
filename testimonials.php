    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="d-flex justify-content-center">
          ...
          <img src="man1.jpg" alt="User Icon" class="rounded-circle mb-3" width="200" height="200">
      ...
      <div class="carousel-item">
        <div class="d-flex justify-content-center">
          <div class="text-center p-4"> <img src="man1.jpg" alt="User Icon" class="rounded-circle mb-3" width="200" height="200">
